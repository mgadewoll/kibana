...
tester.run('prefer_kbn_ui_callout', PreferKbnUiCallout, {
  valid: [
    ...
    {
      name: 'using a semantic DangerCallout wrapper component is allowed',
      code: `
        <DangerCallout title="Error" />;
      `,
    },
  ],
  invalid: [
    ...
    {
      name: 'using <EuiCallOut color="danger"> suggests DangerCallout',
      code: `
      ...
      errors: [
        {
          messageId: 'noDirectEuiCallOutJsxWithColor',
          data: { wrapper: 'DangerCallout', color: 'danger' },
        },
      ],
    },
    {
