...
export const PreferKbnUiCallout: Rule.RuleModule = {
  meta: {
    ...
    messages: {
      noDirectEuiCallOutJsx: `Use a semantic wrapper from '${SEMANTIC_PACKAGE}' instead of <EuiCallOut> directly. Choose InfoCallout, SuccessCallout, WarningCallout, or DangerCallout based on intent.`,
